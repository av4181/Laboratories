CREATE OR REPLACE PACKAGE PKG_SAMENS2_M5_LABORATORIES
AS
    ...
    PROCEDURE bewijs_milestone_M5_S2(p_aantal_w_laboraties IN NUMERIC, p_aantal_x_measurements IN NUMERIC,
